...
func newChatMessage(db *gorm.DB, opts ...gen.DOOption) chatMessage {
	...
	_chatMessage.UserID = field.NewInt32(tableName, "user_id")
	_chatMessage.RoomID = field.NewInt32(tableName, "room_id")
	_chatMessage.Content = field.NewString(tableName, "content")
	_chatMessage.CreatedAt = field.NewInt64(tableName, "created_at")
	_chatMessage.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_chatMessage.DeletedAt = field.NewInt64(tableName, "deleted_at")
...
func (c *chatMessage) updateTableName(table string) *chatMessage {
	...
	c.RoomID = field.NewInt32(table, "room_id")
